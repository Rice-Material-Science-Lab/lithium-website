...
export default function DisplayHexGrid({ data, width, height }: { data: number[], width: number, height: number }) {
  const hexagons = [];
  ...
  const getColor = (value: number) => {
    switch(value) {
      case 0: return '#000000'; // black (empty)
      case 1: return '#2563eb'; // blue (free)
      case 2: return '#f97316'; // orange (deposited)
      case 3: return '#374151'; // dark gray (substrate)
      case 4: return '#22c55e'; // green (passivated)
